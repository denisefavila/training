...
from interview.interview.graph.distance_from_source import min_distance_from_source
...
def test_bfs_directed():
    ...
    expected_0_1 = {0: 0, 1: 1, 2: 1, 3: 2, 4: 2}
    distances, _ = min_distance_from_source(directed_graph_1, 0)
    assert distances == expected_0_1
